...
\end{align}	
Den beregnede regulator i ligning \ref{eq:reg_pd_final} er således med til at give et fasemargin på $pm=39,5^{\circ}$ på det kompenserede system, se figur \ref{reg_bode_all}.
