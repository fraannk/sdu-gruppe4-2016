...
\begin{align}
	& X=2\pi f L \nonumber
\end{align}
Hvor induktansen L for en solenoide er givet ved Wheelers formel i ligning \ref{eq:Wheeler}\husk{Simon}{fodnote:http://microblog.routed.net/wp-content/uploads/2008/10/pancakewheel.pdf}
\begin{align}
...
\end{figure}\\
For at eftervise dette, blev der i laboratoriet, målt med en Gauss meter af typen. \husk{Simon}{Find ud af Gauss meter model, og lav evt. ny maaling}
