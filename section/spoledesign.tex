...
I følgende afsnit vil den teoretiske del blive anvendt, til at finde de værdier, der bliver brugt i spoledesignet.\\
...
&i=0.05\cdot sin(2pi\cdot 46936\cdot t)
\end{align}
Frekvensen og peakstrømmen er dimensioneret ud fra afsnit. \husk{Simon}{Ref til Frekv. generator}
Her ses en induceret spænding med en peak to peak på ca. 6\volt. Denne graf er plottet ud fra ligning
...
\subsection{Simluering}
I dette underafsnit bliver teorien simuleret.
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\textwidth]{billeder/Comsol_B_field_begge.png}
	\caption{Magnetfeltet simuleret 13 $\mm$ ud fra stor spole, i ligeposition}
	\label{fig:B_Comsol_begge}
\end{figure}
\begin{figure}[h!]
	\centering
	\includegraphics[width=.8\textwidth]{billeder/Comsol_B_field.png}
	\caption{Magnetfeltet simuleret 13 $\mm$ ud fra stor spole, ved fuld overlappelse}
	\label{fig:B_Comsol}
\end{figure}
