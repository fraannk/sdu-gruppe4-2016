...
Til dette anvendes ligning 4 i databladet \cite[Side 11]{NE555}. Denne ligning isoleres for kondensatoren.
...
Dette giver en duty-cycle på $49 \%$ og en frekvens $F_c = 46.9 \si{\kilo\hertz}$. 
